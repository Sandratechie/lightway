      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="grid lg:grid-cols-5 gap-6 lg:gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            >
              <div className="w-11 h-11 md:w-12 md:h-12 bg-gradient-brand rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <a 
              ...
              className="flex items-center justify-center gap-3 w-full bg-[#25D366] text-primary-foreground px-6 py-3.5 rounded-xl font-semibold hover:bg-[#20BD5A] transition-colors"
            >
          ...
          {/* Contact Form */}
          <div className="lg:col-span-3 bg-card rounded-2xl p-5 sm:p-6 md:p-8 border border-border shadow-card">
            ...
            <form className="space-y-4 md:space-y-5">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2.5 md:py-3 bg-background border border-border rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors text-foreground text-sm md:text-base"
              ...
              <div>
                ...
                <select className="w-full px-4 py-2.5 md:py-3 bg-background border border-border rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors text-foreground text-sm md:text-base">
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="w-full px-4 py-2.5 md:py-3 bg-background border border-border rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors resize-none text-foreground text-sm md:text-base"
