      ...
      <div className="container mx-auto container-padding">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 lg:gap-8">
          {projects.map((project, index) => (
            <div
              key={project.id}
              className="group bg-card rounded-xl overflow-hidden shadow-card card-hover border border-border animate-fade-up"
            ...
            >
              ...
              <div className="relative h-48 sm:h-52 md:h-60 overflow-hidden">
                ...
                <div className="absolute bottom-3 left-3">
                  <span className="text-xl md:text-2xl font-bold text-primary-foreground">{project.price}</span>
                </div>

                {/* Arrow */}
                <div className="absolute top-3 right-3 w-9 h-9 bg-primary-foreground/20 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:bg-secondary">
